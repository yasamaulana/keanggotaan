                ...
                <nav class="flex h-9 items-center justify-between" aria-label="Global">
                    <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
                        <a href="#" class="-m-1.5 p-1.5">
                            ...
                            <i class="fa-solid fa-users" style="font-size: 2vw; color: rgb(3, 205, 205)"></i>
                        </a>
                    </div>
                    ...
                    <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
                        <a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Produk</a>

                        <a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Harga</a>
                    </div>
        ...
        <main>
            <div class="relative px-6 lg:px-8">
                <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                    <div>
                        <div>
                            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Ayo bergabung
                                dengan kami dengan keanggotaan yang murah</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Daftarkan diri dan jadilah
                                anggota bersama kami</p>
                            ...
                            <svg class="relative left-[calc(50%+3rem)] h-[21.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[42.375rem]"
                                ...
                                <defs>
                                    <linearGradient id="ecb5b0c9-546c-4772-8c71-4d3f06d544bc" x1="1155.49"
                                        x2="-78.208" y1=".177" y2="474.645" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#9089FC"></stop>
                                        <stop offset="1" stop-color="#FF80B5"></stop>
                                    </linearGradient>
                                </defs>
